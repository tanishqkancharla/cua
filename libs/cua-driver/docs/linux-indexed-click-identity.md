...
cannot replace an older token's cached map. Token validity and object liveness
are checked again after the cursor overlay await, before delivery. Uncertain
activation failures never replay through pointer input.
