...
Local rustfmt and whitespace checks pass. The candidate is not yet built or GUI-tested. Matching observed key hold and testing the unchanged failing program remain required before claiming an input fix.
